	...
	*/
	...
	function Move(){ 
		...
		if($secondBG.hasClass("inview")){
			...
			bg2.css({'backgroundPosition': newPos(70, windowHeight, pos, 4010, 0.2)});
			//call the newPos function and change the second background position
		}
		...
		if ($fifthBG.hasClass("inview")){
			//call the newPos function and change the background position
			$fifthBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 6850, 0)});
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			//call the newPos function and change the second background position
			bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 4810, 0.20)});
		}

		if ($sixthBG.hasClass("inview")){
			//call the newPos function and change the background position
			$sixthBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 9850, 0)});
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			//call the newPos function and change the second background position
			bg6.css({'backgroundPosition': newPos(50, windowHeight, pos, 12810, 0.20)});
		}
